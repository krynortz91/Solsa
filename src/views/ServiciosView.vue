       ...
       <div class="container shadow section-sm rounded pt-5">
           <div class="row">
               ...
               <div class="col-lg-3">
                   <ul class="sidenav">
                       <li class="sidelist">
                           <a href="#mecanizado">Mecanizados en Terreno</a>
                       </li>
                       <li class="sidelist">
                           <a href="#arriendo-equipos">Arriendo de Equipos de Apoyo</a>
                           <ul>
                               <li class="sidelist">
                       ...
                       <li class="sidelist">
                           <a href="#arriendo-camionetas">Arriendo de Camionetas 4x4 con equipamiento Minero</a>
                       </li>
                       <li class="sidelist">
                           <a href="#reparacion-equipos">Reparación de Equipos Autónomos</a>
                           <ul>
                               <li class="sidelist">
                       ...
                       <li class="sidelist">
                           <a href="#ferreteria">Ferretería especializada</a>
                           <ul>
                               <li class="sidelist">
               ...
               <div class="col-lg-8">
                   <div class="px-lg-5 px-4" id="mecanizado">
                   ...
                   <div class="px-lg-5 px-4 pt-5" id="arriendo-equipos">
                   ...
                   <div class="px-lg-5 px-4 pt-5" id="arriendo-camionetas">
                   ...
                   <div class="px-lg-5 px-4 pt-5" id="reparacion-equipos">
                   ...
                   <div class="px-lg-5 px-4 pt-5" id="proyectos">
                       <h2 id="collapse">Proyectos</h2>
                       <div class="content">
                   ...
                   <div class="px-lg-5 px-4 pt-5 pb-5" id="ferreteria">
                       <h2 id="collapse">Ferretería especializada</h2>
                       <div class="content">
